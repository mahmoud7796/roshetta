<?php
  ...
  if(isset($_POST['create'])){
    ...
    $patient_id=$_POST['patient_id'];
      ...
      $sql = "insert into `patients`(medicine,notes, patient_id) values('$medicine','$notes','$patient_id')";
...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <select name="medicine" id="medicineType" class="form-select" autocomplete="off">
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control" placeholder="Post your comments here ..." rows="3" id="notes" name="notes" autocomplete="off"></textarea>
      <input type="hidden" value="<?php echo $_GET['patientId'] ?>" name="patient_id">
